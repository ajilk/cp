...
**Core Insight**: Greedily expand the shortest known path first. Once a vertex is finalized (popped from the priority queue), its shortest distance is guaranteed.
...
- [743. Network Delay Time](../leetcode/graph/743.md)
